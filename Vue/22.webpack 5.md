...
>
> webpack4及以上，webpack打包在01-webpack的起步目录下打开终端 `webpack ./scr/main.js -o ./dist/bundle.js`
...
> 再次使用`webpack ./src/main.js -o ./dist --mode=development `，重新打包
...
- 打包html资源
  ...
  这样打包就可以成功了  但是要是在html中插入图片 发现图片打包不了 是因为还少一个html-loader
