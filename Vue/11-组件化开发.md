  ...
  <script>
    ...
    const cpn = {
      ...
      props: { //对象写法
        ...
        // cmovies:Array,
        // cmessage:String,
        // cmessage:['String','Number'],这个写法在vuecli项目中报错，error  The "message" property should be a constructor  vue/require-prop-type-constructor 改为[String,Number]
        // cmessage:String|Number 这个写法也在vuecli项目中报错，error  The "message" property should be a constructor  vue/require-prop-type-constructor 改为[String,Number]
        // 2.提供一些默认值，以及必传值
        cmessage: {
          type: String,
          default: 'zzzzz',
